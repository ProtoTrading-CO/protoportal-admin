...
export const WORKFLOW_META = {
  ...
  'order sent': { label: 'Order Sent', color: '#16a34a', bg: '#dcfce7', step: 3 },
...
export function orderMatchesTab(order, tab) {
  ...
  if (tab === 'sent') return key === 'order sent';
  if (tab === 'paid') return key === 'payment received';
  return true;
}
