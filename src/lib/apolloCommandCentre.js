...
export const APOLLO_WORK_OBJECTS = [
  ...
  },
  {
    ...
    statusBadge: APOLLO_WORK_STATUS_BADGES.ready,
    roleLabel: 'Operational',
    summary: 'Record supplier rules, confirmed incoming stock and buyer-controlled replenishment facts.',
    modules: ['Supplier rules', 'Incoming stock', 'Receipts', 'Replenishment', 'Apollo'],
    openLabel: 'Open Buying',
  },
];
