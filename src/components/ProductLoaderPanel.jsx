...
export default function ProductLoaderPanel({
  ...
  const [batchDefaultSub2Id, setBatchDefaultSub2Id] = useState('');
  const [batchDefaultSub3Id, setBatchDefaultSub3Id] = useState('');
  const [batchDefaultSub4Id, setBatchDefaultSub4Id] = useState('');
    ...
    <div className="adm-panel" style={{ maxWidth: 1100 }}>
      ...
      {activeTab === 'nutstore' && (
        <ProductLoaderNutstore
          ...
          batchDefaultSub2Id={batchDefaultSub2Id}
          setBatchDefaultSub2Id={setBatchDefaultSub2Id}
          batchDefaultSub3Id={batchDefaultSub3Id}
          setBatchDefaultSub3Id={setBatchDefaultSub3Id}
          batchDefaultSub4Id={batchDefaultSub4Id}
          setBatchDefaultSub4Id={setBatchDefaultSub4Id}
